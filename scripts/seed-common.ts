...
export function seed(db: Db, sqlite: Database.Database, now: number) {
  ...
  db.insert(contacts)
    .values([
      { id: "contact_dana", email: "dana@acme.com", firstName: "Dana", lastName: "Whitfield", nameSource: "supabase", organizationId: "org_acme", stripeCustomerId: "cus_dev_dana", plan: "Growth", planStatus: "active", source: "stripe", createdAt: at(90 * DAY), updatedAt: at(2 * DAY) },
      { id: "contact_marcus", email: "marcus@acme.com", firstName: "Marcus", lastName: "Lee", nameSource: "supabase", organizationId: "org_acme", stripeCustomerId: "cus_dev_marcus", plan: "Growth", planStatus: "active", source: "stripe", createdAt: at(88 * DAY), updatedAt: at(5 * DAY) },
      { id: "contact_priya", email: "priya@birchwood.io", firstName: "Priya", lastName: "Raman", nameSource: "supabase", organizationId: "org_birchwood", stripeCustomerId: "cus_dev_priya", plan: "Starter", planStatus: "trialing", source: "stripe", createdAt: at(60 * DAY), updatedAt: at(3 * DAY) },
      { id: "contact_jonah", email: "jonah@sunrisemedia.co", firstName: "Jonah", lastName: "Beck", nameSource: "stripe", organizationId: "org_sunrise", stripeCustomerId: "cus_dev_jonah", plan: "Pro", planStatus: "active", source: "stripe", createdAt: at(45 * DAY), updatedAt: at(10 * DAY) },
      { id: "contact_elena", email: "elena@sunrisemedia.co", firstName: "Elena", lastName: "Souza", nameSource: "supabase", organizationId: "org_sunrise", stripeCustomerId: "cus_dev_elena", plan: "Pro", planStatus: "canceled", source: "stripe", createdAt: at(44 * DAY), updatedAt: at(30 * DAY) },
      { id: "contact_tom", email: "tom.alvarez@gmail.com", firstName: "Tom", lastName: "Alvarez", nameSource: "gmail", organizationId: null, stripeCustomerId: "cus_dev_tom", plan: "Starter", planStatus: "active", source: "stripe", createdAt: at(30 * DAY), updatedAt: at(1 * DAY) },
    ])
    .run()
