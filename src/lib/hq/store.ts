...
function buildSeed(): HQCard[] {
  ...
  return [
    ...
    },
    {
      ...
      label: undefined,
      description:
        "Voice memo on a drawing play — no owner. Coach records a quick audio annotation directly on a play drawing.",
      estimate_hours: undefined,
      comments: [],
      updated_at: ago(36),
    },
    ...
    },
    {
      ...
      label: "feature",
      description:
        "Coaches need a home for the people and folders they share with — not another drawing canvas. This card is the profile, the staff list, and the folders a second account can actually open. It sits on the sharing branch; Share a Play is a different ticket and is not shipped. Dev is in SwiftUI loop 3 of 8 on the staff list.",
      estimate_hours: 11,
      comments: [
        {
          id: "cmt-001",
        ...
        },
        {
          id: "cmt-004",
          author: "QA Agent",
          body: "Blocked on iPad 11 snapshots elsewhere. I can take Coach Network once Play headers goes green — not before.",
          created_at: ago(0.63),
        },
        {
          id: "cmt-005",
